  ...
  return (
    <>
      ...
      <div className="mb-[22px]">
        <h2 className="text-[1.65rem] font-extrabold text-[#09090B] tracking-tight mb-1.5">Welcome Back</h2>
        <p className="text-[0.85rem] text-gray-500">Enter your credentials to access the platform console</p>
      </div>
